    ...
    <main>
        ...
        <x-info-section bgi="bg-[url('/public/assets/img/about-2.jpg')]" heading="Nasza Pasja">
            <p class="text-base 2xl:text-lg" style="line-height: 1.6 ">Od pierwszego dnia, kiedy otworzyliśmy drzwi
                ...
                miłością do autentycznej, włoskiej pizzy.</p>
            <p class="text-base 2xl:text-lg" style="line-height: 1.6 ">Każdego dnia z zaangażowaniem przygotowujemy
                każdy
                składnik, dbając o najwyższą jakość i świeżość. Nasza pasja do gotowania sprawia, że każdy
                kawałek
                pizzy, który serwujemy, jest małym dziełem sztuki, pełnym smaku i aromatu.</p>
            <p class="text-base 2xl:text-lg" style="line-height: 1.6 ">Wierzymy, że prawdziwa
        ...
        <x-info-section bgi="bg-[url('/public/assets/img/about-3.jpg')]" heading="Nasza Restauracja" mirrorLook="true">
            ...
            <p class="text-base 2xl:text-lg" style="line-height: 1.6 ">Każdy element wystroju został starannie dobrany,
                ...
                zespół zadba o to, abyś czuł się wyjątkowo.</p>
        ...
        <x-info-section bgi="bg-[url('/public/assets/img/about-4.jpg')]" heading="Nasza Pizza">
            ...
            <p class="text-base 2xl:text-lg" style="line-height: 1.6 ">Wykorzystujemy tylko najwyższej jakości
                ...
                chrupkość. </p>
            <p class="text-base 2xl:text-lg" style="line-height: 1.6 ">Każdy kęs naszej pizzy to podróż do słonecznej
                Italii, pełna niezapomnianych wrażeń kulinarnych. Skosztuj naszych wyjątkowych kompozycji i przekonaj
                się, dlaczego nasza pizza jest tak wyjątkowa.</p>
        </x-info-section>
