            ...
            <div class="w-full lg:w-[50%] max:w-[45%] xl:h-[83vh] 2xl:h-[87vh] max:h-[89vh] overflow-y-scroll ">
                ...
                <div class="flex flex-col justify-center items-center gap-12 sm:gap-20 lg:gap-28 mt-6 lg:mt-24 ">
                    ...
                    <div
                        ...
                        <x-contact-info-item><span>Ludźmierska 26A <br> Nowy Targ</span></x-contact-info-item>
                        <x-contact-info-item> <a href="tel:+48453400244">+48 453 400 244</a></x-contact-info-item>
                        <x-contact-info-item> <a
                    ...
                    <div class=" w-[90%] sm:w-[80%] flex flex-col justify-center items-center gap-12 mb-12">
                        <iframe
                            ...
                            class="w-full h[-400px] 2xl:h-[600px] grayscale hover:grayscale-0 duration-500 "></iframe>
                    </div>
                </div>
            </div>
    </main>
