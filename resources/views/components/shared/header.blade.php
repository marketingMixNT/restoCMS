<header class="flex justify-end sm:justify-between items-start  md:px-8 absolute left-8 right-8 top-8 ">
    ...
    <a wire:navigate href="{{ route('home.index') }}" class="absolute top-0 left-1/2 -translate-x-1/2 z-50"><img
