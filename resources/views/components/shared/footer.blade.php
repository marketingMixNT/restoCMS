...
<footer class="absolute bottom-0 left-0 right-0 text-white flex flex-col sm:flex-row justify-between items-center px-12 pb-6 sm:py-12 gap-2 sm:gap-0{{$class}}">
